...
public class Achievement {
    ...
    public static boolean broadcast(Player player, String achievementId) {
        ...
        String translation = player.getDisplayName() + " has just earned the achievement " + TextFormat.GREEN + achievements.get(achievementId).getMessage();
    ...
    public void broadcast(Player player) {
        String translation = player.getDisplayName() + " has just earned the achievement {%1}" + TextFormat.GREEN + this.getMessage();
