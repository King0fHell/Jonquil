...
public class Server {
    ...
    private static final MainLogger log = Nukkit.log;
    ...
    Server(final String filePath, String dataPath, String pluginPath) {
        ...
        log.info(TextFormat.BOLD.WHITE + "Starting Minecraft: BE server | " + TextFormat.AQUA + this.getVersion() + TextFormat.BOLD.WHITE);
        ...
        log.info("This server is running " + this.getName() + " version " + TextFormat.YELLOW + this.getNukkitVersion() + TextFormat.WHITE + "(Api: " + this.getApiVersion() + ")");
    ...
    public void forceShutdown() {
        ...
        try {
            ...
            log.critical("Exception happened while shutting down, exiting the process", e);
            System.exit(1);
        }
    }
    ...
    public void start() {
        ...
        log.info("Loaded " + new CraftingManager().recipes.size() + " recipes.");
        System.out.println("");
        log.info("Done (" + (double) (System.currentTimeMillis() - Nukkit.START_TIME) / 1000 + "s)! For help, type \"help\" or \"?\"");
    ...
    public void tickProcessor() {
        ...
        try {
            ...
            log.critical("Exception happened while ticking server", e);
            log.critical(Utils.getAllThreadDumps());
        }
    }
    ...
    public Optional<UUID> lookupName(String name) {
        ...
        if (uuidBytes.length != 16) {
            log.warning("Invalid uuid in name lookup database detected! Removing");
    ...
    public void saveOfflinePlayerData(String name, CompoundTag tag, boolean async) {
        if (this.shouldSavePlayerData()) {
            try {
                ...
                log.error("Could not save player \"" + name + "\": " + e.getMessage());
            }
        }
    }
    ...
    public boolean loadLevel(String name) {
        ...
        try {
            ...
            log.error("Could not load level " + name + " | " + e.getMessage());
            return false;
        }
    ...
    public boolean generateLevel(String name, long seed, Class<? extends Generator> generator, Map<String, Object> options, Class<? extends LevelProvider> provider) {
        ...
        try {
            ...
            log.error("Could not generate level " + name + " | " + e.getMessage());
            return false;
        }
